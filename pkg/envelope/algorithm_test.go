...
//TODO: these test don't consider oneAndZeroes padding, need to fix
func Test_aes_cbc_encrypt(t *testing.T) {
...
func Test_aes_cbc_padding_encrypt(t *testing.T) {
	data, err := hex.DecodeString("a0a1a2a3a4a5a6a7a8a9aaabacadaeafb0b1b2b3b4b5b6b7b8b9babbbcbdbebfc0c1c2c3c4c5c6c7c8c9cacbcccdcecfd0d1d2d3d4d5d6d7d8d9dadbdcdddedfda")
	if err != nil {
		panic(err)
	}
	key, err := hex.DecodeString("56e47a38c5598974bc46903dba290349")
